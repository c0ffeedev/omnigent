...
def register_core_routes(
    ...
    *,
    ...
    async def update_session(
        ...
        elif body.archived is not None or set_project or set_team:
        ...
        if body.labels:
            # Preserve upstream's per-user pinned-label boundary while also
            # enforcing the fork's internal actor-label protection.
