...
describe("authenticated Teams ingress", () => {
  ...
  it.each([
    ...
    ["team channel scope", body({ conversation: { id: "conversation-1", conversationType: "channel", tenantId } })],
    ["meeting scope", body({ conversation: { id: "conversation-1", conversationType: "meeting", tenantId } })],
    ["missing scope", body({ conversation: { id: "conversation-1", tenantId } })],
